#!/bin/bash
# Скрипт для исправления всех файлов с правильными импортами
...
# 2. User.kt - упрощенная версия без timestamp defaultExpression
...
# 3. UserRepository.kt - правильный синтаксис для UUID
